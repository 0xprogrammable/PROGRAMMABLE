export const PACKAGE_VERSION = "2.0.0-rc.1";
...
export const LAUNCH_PROFILE_REVISION = 1;
export const LAUNCH_PROFILE_VERSION = "2.0.0-rc.1";
...
export const RELEASE_TAG = "programmable-launch-v2.0.0-rc.1";
export const RELEASE_TARBALL = "programmable-launch-2.0.0-rc.1.tgz";
