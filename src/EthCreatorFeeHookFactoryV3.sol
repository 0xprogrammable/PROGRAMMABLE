...
/// @title EthCreatorFeeHookFactoryV3
/// @notice Deterministically deploys the Classic V3 shared fee hook at a valid v4 hook address.
contract EthCreatorFeeHookFactoryV3 {
    ...
    function deploy(
    ...
    ) external returns (EthCreatorFeeHookV3 hook) {
        ...
        hook = EthCreatorFeeHookV3(deployed);
    ...
    function initCode(
        ...
        return abi.encodePacked(
            type(EthCreatorFeeHookV3).creationCode, abi.encode(poolManager, launcherFeeRecipient, feeSplitVaultFactory)
        );
    }
