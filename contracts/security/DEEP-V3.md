...
- 87 tests passed, 0 failed, 0 skipped across 14 suites.
...
The release sources were clean against the recorded commit when this evidence was produced.
...
- two independent funded wallets launching without an allowlist, operator approval or privileged caller;
...
| Testing and verification | Moderate — 2/4 | The focused suite has 87 passing tests, 10,000-case fuzz tests, 640,000 invariant handler calls, deterministic deployment rehearsals and a pinned Mainnet fork. There is no published 100% branch/statement coverage, mutation testing, formal proof, external audit or live Mainnet canary evidence. |
...
CI result: 87 passed, 0 failed, 0 skipped.
