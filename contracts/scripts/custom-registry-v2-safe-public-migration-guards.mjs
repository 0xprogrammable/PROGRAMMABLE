...
export const SAFE_PUBLIC_MIGRATION_POLICY_SCHEMA =
  "programmable.custom-registry-v2-safe-public-migration-policy.v1";
...
export const SAFE_PUBLIC_MIGRATION_PLAN_SCHEMA =
  "programmable.custom-registry-v2-safe-public-migration-plan.v1";
export const SAFE_PUBLIC_MIGRATION_RECEIPTS_SCHEMA =
  "programmable.custom-registry-v2-safe-public-migration-receipts.v1";
export const SAFE_PUBLIC_MIGRATION_VERIFICATION_SCHEMA =
  "programmable.custom-registry-v2-safe-public-migration-verification.v1";
