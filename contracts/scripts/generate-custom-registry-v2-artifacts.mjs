...
const sourcePaths = [
  ...
  "contracts/scripts/custom-registry-v2-safe-public-migration-execution.mjs",
  "contracts/scripts/stage-custom-registry-v2-safe-public-migration-transaction.mjs",
  "contracts/scripts/authorize-custom-registry-v2-safe-public-migration.mjs",
  "contracts/scripts/broadcast-custom-registry-v2-safe-public-migration.mjs",
  "contracts/scripts/assemble-custom-registry-v2-safe-public-migration-receipts.mjs",
  ...
  "contracts/scripts/test/custom-registry-v2-safe-public-migration-execution.test.mjs",
  ...
  "contracts/test/CustomRegistryV2SafePublicMigrationMainnetFork.t.sol",
...
const manifest = {
  ...
  controllerCustody: {
    model: releasePolicy.temporaryPublicControllerCustody,
    controllerSafes: 4,
    ownersPerSafe: 1,
    threshold: 1,
    sameHostConcentrationAccepted:
      releasePolicy.sameHostConcentrationAccepted,
    restartReadbackRequiredForPublicActivation:
      releasePolicy.restartReadbackRequiredForPublicActivation,
    encryptedBackupRequiredForPublicActivation:
      releasePolicy.encryptedBackupRequiredForPublicActivation,
    hardwareTwoOfThreeMigrationRequiredForPublicActivation:
      releasePolicy.hardwareTwoOfThreeMigrationRequiredForPublicActivation,
    hardwareTwoOfThreeMigrationDeferred:
      releasePolicy.hardwareTwoOfThreeMigrationDeferred,
  },
  sourceDigests,
  compiler: {
    version: "0.8.26",
