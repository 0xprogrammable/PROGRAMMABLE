...
contract EthCreatorFeeHookV4 is BaseHook, IUnlockCallback, ReentrancyGuardTransient, IHookEvents, IHookSwapEvents {
    ...
    uint16 public constant MIN_TOTAL_SWAP_FEE_BPS = 10;
    uint16 public constant MAX_TOTAL_SWAP_FEE_BPS = 1000;
    uint16 public constant TOTAL_SWAP_FEE_STEP_BPS = 10;
        ...
        returns (uint256 creatorFee, uint256 launcherFee)
    {
        ...
        if (totalSwapFeeBps == LAUNCHER_FEE_BPS) return (0, totalFee);
