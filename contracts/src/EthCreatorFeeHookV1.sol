...
/// @title EthCreatorFeeHookV1
/// @notice Splits each pool's selected total ETH swap fee between its creator and Launcher.
...
///      1-10% total fee; it is never added on top. The contract is non-upgradeable and has no administrative controls.
contract EthCreatorFeeHookV1 is BaseHook, IUnlockCallback, ReentrancyGuardTransient {
    ...
    function _accrue(
        ...
        totalNativeFeesAccrued += creatorFee + launcherFee;
