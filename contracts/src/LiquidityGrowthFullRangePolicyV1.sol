...
/// @title LiquidityGrowthFullRangePolicyV1
/// @notice The fixed economic and execution envelope for the first full-range liquidity-growth launch model.
/// @dev V1 has one public configuration: a 0.05 ETH target and 150M-token reserve. The reserve is at least four times
...
library LiquidityGrowthFullRangePolicyV1 {
    ...
    uint64 internal constant COMPOUND_COOLDOWN_SECONDS = 30 minutes;
    ...
    bytes32 internal constant LOCKED_POSITION_SALT = keccak256("programmable.liquidity-growth.full-range.position.v1");
