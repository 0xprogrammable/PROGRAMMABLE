...
## 4. Lifecycle canary preparation
...
The plan fixes the canary name, symbol, deterministic creator salt, metadata, `0.0006 ETH` activation buy, beneficiary, fees and Deep30 preset. It also caps all four swap amounts before any signature, pins the D92 Mainnet Universal Router to its V2.0 five-field single-hop ABI, fixes 1% slippage and a five-minute deadline policy, and requires the canonical V4Quoter at each transaction's parent block.
