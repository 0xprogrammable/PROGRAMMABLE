...
| Adaptive | In development | A market-cap curve sets the swap fee as the token price moves |
| Deep | Prepared, not deployed | Creator fees deepen the original permanently locked pool before creator rewards begin |
...
Later contract versions and launch models remain unavailable until their own manifests and lifecycle evidence are complete. A passing local test suite is not a production deployment.
...
- [`contracts/security/ADAPTIVE-CURVE-V1.md`](./contracts/security/ADAPTIVE-CURVE-V1.md)
