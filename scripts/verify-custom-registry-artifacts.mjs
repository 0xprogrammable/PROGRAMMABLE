...
const expectedGenerationTwoReleaseCandidateFileHash =
  "sha256:ab460890036d37fadb07770a52225a8bff49f8506b40fcf46bf857792bae1af0";
const expectedGenerationTwoBuilds = new Map([
  [
    "ProgrammableCustomRegistryV2",
    {
      ...
      artifactBindingHash: "sha256:cfb89562b9cce1244143d3eeba2e7c92fa3f2cf448d4355b87417ae1a0f97cc0",
  ...
  [
    "ProgrammableCustomPartnerFactoryRegistryV2",
    {
      ...
      artifactBindingHash: "sha256:59fce90f7cf9f84e83e55402a2b8887e3f6c78f1a04d0a986c745f3c6bb66a71",
  ...
  [
    "ProgrammableCustomAtomicRegistrarV2",
    {
      ...
      artifactBindingHash: "sha256:5ec3be6ba30e5af684416e4baf7190d8d183dab0d7ffc830cf28c217da2a9a20",
...
process.stdout.write(
  `verified ${contracts.length} Generation 1 published ABIs, ${builtEvents.length} Generation 1 event signatures, `
    ...
    + "and the four-contract Ethereum Mainnet Generation 1 deployment evidence\n",
);
