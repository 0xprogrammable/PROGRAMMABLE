...
from (values
  ...
  ('91400000-0000-0000-0000-000000000016'::uuid, 'creator-hook-claim', 'hook', 'CreatorFeesClaimed', decode(repeat('10', 32), 'hex')),
  ('91400000-0000-0000-0000-000000000017'::uuid, 'launcher-hook-claim', 'hook', 'LauncherFeesClaimed', decode(repeat('20', 32), 'hex')),
  ('91400000-0000-0000-0000-000000000018'::uuid, 'creator-fee-checkpoint', 'reward_vault', 'CreatorFeesCheckpointed', decode(repeat('30', 32), 'hex')),
  ('91400000-0000-0000-0000-000000000019'::uuid, 'reward-configuration-activation', 'reward_vault', 'CtoRewardConfigurationActivated', decode(repeat('40', 32), 'hex')),
...
select is(
  ...
  array[
    ...
    'candidate_disposition:91220000-0000-0000-0000-000000000001',
    'candidate_disposition:91220000-0000-0000-0000-000000000002',
    'candidate_disposition:91220000-0000-0000-0000-000000000003',
    'candidate_disposition:91220000-0000-0000-0000-000000000020',
    'claim:98260000-0000-0000-0000-000000000001',
    'creator_hook_claim:91600000-0000-0000-0000-000000000001',
    ...
    'launcher_hook_claim:91600000-0000-0000-0000-000000000002',
