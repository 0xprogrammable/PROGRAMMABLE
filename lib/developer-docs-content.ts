...
export const developerDocsMarkdown = [
  ...
  "",
  "Partner, template, model, builder and origin attribution are additional facts. They never create a third public category. A token name, ticker, logo, creator tag, pull request or lookalike registry event is not provenance.",
  "",
  ...
  "",
  "No Basebit, Aion or other named partner activation is implied by this specification. A named partner requires exact template, recipient, deployment and onchain fee evidence.",
  "",
  ...
  "",
  "Read fee basis, currency, recipients, verification, rounding, accrual and claim evidence from each record. Fail closed when shares or recipients cannot be proven, the total differs, one party can claim the other's share or the normal native fee is added again.",
  "",
...
export const programmableLlmsIndex = [
  ...
  "- Partner, template and model are attribution, not public categories.",
  ...
  `- Partner template target policy: ${PROGRAMMABLE_FEE_POLICY.partnerTemplate.totalBps} BPS total, split ${PROGRAMMABLE_FEE_POLICY.partnerTemplate.partnerShareBps} partner and ${PROGRAMMABLE_FEE_POLICY.partnerTemplate.programmableShareBps} Programmable, with no added native fee.`,
