...
export function buildDeveloperDocsMarkdown(): string {
  return [
    ...
    "The mandatory 10 bps Programmable share may be additive or included in the selected total, but the revision-3 admission receipt does not certify arbitrary custom fee behavior. Funding may be absent, use exact native Router transaction value, or use a separate unsigned EIP-3009 descriptor. Funding signing and Router sending remain separate explicit wallet actions; neither is automatic.",
    "",
