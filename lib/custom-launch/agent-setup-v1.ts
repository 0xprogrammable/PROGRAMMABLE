...
export const PROGRAMMABLE_AGENT_SETUP_TEXT_V1 = Object.freeze([
  ...
  "Wallet keys require launchWallet to equal their wallet binding. Partner roots and subkeys may select the exact controller in the immutable request but cannot sign for it. Partner launch reads are credential-principal isolated: roots do not aggregate child history, and rotating a child does not migrate its private launch history. The current Router V1 permit-reissue disposition endpoint accepts wallet keys only; a partner launch recovers by packing and submitting a new request.",
