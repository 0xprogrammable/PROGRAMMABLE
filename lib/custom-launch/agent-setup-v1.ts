...
export const PROGRAMMABLE_AGENT_SETUP_TEXT_V1 = Object.freeze([
  ...
  "Preflight is quota-free: quotaConsumed, nonceAllocated and persisted must all be false. It never creates a wallet action. walletSignatureRequiredLater is true and walletBroadcastByService is false. Local CLI checks and remote preflight prepare and classify exact bytes; they are not the launch decision.",
