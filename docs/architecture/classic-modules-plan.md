...
- Creator-Einnahmen können auf bis zu zehn Empfänger mit unveränderlichen Anteilen aufgeteilt werden. Modulanteile sind davon getrennt.
...
- Autor-Wallets können nur vom jeweiligen Autor für zukünftige Einnahmen geändert werden. Creator-Wallets erhalten die im Handover beschriebene begrenzte Eigen-/Reward-Admin-Rotation; niemand kann dabei Anteile, Gebühren, Supply, Handel oder bestehende Ansprüche verändern.
