...
| Integrate a Robinhood terminal | [Robinhood terminal contract](https://programmable.market/developer-reference/robinhood-terminal-indexer) | Bind to `eip155:4663`, index finalized Router stamps and preserve explicit fee, market and security states                     |
