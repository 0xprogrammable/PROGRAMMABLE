...
| Custom Launch CLI 3.3.4 | [public V3 GitHub Release asset](https://github.com/0xprogrammable/PROGRAMMABLE/releases/download/programmable-launch-v3.3.4/programmable-launch-3.3.4.tgz) |
...
default profile is revision 3 with `profileVersion: 3.2.0`; it binds canonical project metadata into the launch hashes.
Exact `3.1.0` and `3.0.0` requests remain readable and byte-identical retryable under their original immutable policies,
