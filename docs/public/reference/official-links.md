...
and revision 2 remains compatible. Profile `3.4.0` and CLI `3.3.8` are preparatory, not live or installable; their
source-tree contracts do not replace discovery or backend activation. V2 and V1 history and schemas remain readable, while fresh creation returns
