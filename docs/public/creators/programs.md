...
Builders use the same [Custom Launch API](../developers/custom-launch.md). It binds one project-specific deterministic bundle to a wallet-owned request. `prepared` contains an artifact; `authorized` contains the transaction for separate wallet review.
