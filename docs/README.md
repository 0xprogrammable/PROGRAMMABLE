...
| Record | Purpose |
| --- | --- |
| [Architecture](../ARCHITECTURE.md) | System boundaries, repository records and versioning |
| [Model library](../MODELS.md) | Human-readable model status |
...
[`releases/`](../releases/) and [`deployments/`](../deployments/).
