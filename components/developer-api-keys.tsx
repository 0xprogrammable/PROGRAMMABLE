...
export const PROGRAMMABLE_MODULE_AGENT_SETUP_TEXT_V1 = [
  ...
  "Use a separate API key with exactly modules:submit and modules:read. Read it from $PROGRAMMABLE_API_KEY in the environment or secret store; never paste, print or copy the secret into chat, source code, logs or command history.",
  ...
  "Use the package schema and limits reported by those capabilities. Build and test your own module locally, then prepare its source package, configuration, declared permissions, documentation and reward-wallet declaration. The intake accepts source without executing it. Do not invent missing package fields.",
