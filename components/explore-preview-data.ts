...
function makePreviewToken(input: {
  ...
  return {
    ...
    indexedValuationBlockNumber: String(23_100_000 + input.id * 420),
...
export const EXPLORE_PREVIEW_TOKENS: CanonicalTokenExploreEntry[] = [
  makePreviewToken({
    ...
    marketCapUsd: "18460000000000000000000000",
  ...
  makePreviewToken({
    ...
    marketCapUsd: "42720000000000000000000000",
  ...
  makePreviewToken({
    ...
    marketCapUsd: "9640000000000000000000000",
  ...
  makePreviewToken({
    ...
    marketCapUsd: "25180000000000000000000000",
  ...
  makePreviewToken({
    ...
    marketCapUsd: "13810000000000000000000000",
  ...
  makePreviewToken({
    ...
    marketCapUsd: "31970000000000000000000000",
  ...
  makePreviewToken({
    ...
    marketCapUsd: "6790000000000000000000000",
  ...
  makePreviewToken({
    ...
    marketCapUsd: "56350000000000000000000000",
  ...
  makePreviewToken({
    ...
    marketCapUsd: "21630000000000000000000000",
