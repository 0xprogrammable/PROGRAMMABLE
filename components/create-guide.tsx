          ...
          <ol className={styles.steps}>
            ...
            <li>
              ...
              <div>
                ...
                <p>
                  Use live discovery profile 3.3.0 and CLI 3.3.7 for current
                  production creation. Profile 3.4.0 and CLI 3.3.8 are
                  preparatory and cannot be installed or submitted yet.
