          ...
          <ol className={styles.steps}>
            ...
            <li>
              ...
              <div>
                ...
                <p>
                  Use the current installable CLI 3.3.8 with its live default
