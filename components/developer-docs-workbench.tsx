...
export function buildDeveloperAgentPrompt(
  ...
  `- Treat canonical Custom discovery as ${PROGRAMMABLE_CUSTOM_DISCOVERY_STATUS} for finalized approved Registry launches and general public submissions as ${PROGRAMMABLE_CUSTOM_PUBLIC_SUBMISSION_STATUS}.`,
  `- Resolve canonical Registry deployments and bindings from /api/v${PROGRAMMABLE_ACTIVE_API_VERSION}/manifest; ${CUSTOM_REGISTRY_PUBLIC_MANIFEST_PATH} separately reports website runtime readiness (${registryManifest.status}).`,
