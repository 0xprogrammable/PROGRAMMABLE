...
type CanonicalIdentityHeaderInput = Readonly<{
  launchSource: string;
...
function canonicalIdentityResponseHeaders(
  input: CanonicalIdentityHeaderInput,
) {
  return {
...
function canonicalResponseHeaders(input: CanonicalIdentityHeaderInput & Readonly<{
  marketAsOf?: string;
  ...
  return {
    ...canonicalIdentityResponseHeaders(input),
...
export async function GET(request: NextRequest) {
  ...
  if (!entry) {
    ...
    return NextResponse.json(
      ...
      {
        status: 404,
        headers: canonicalIdentityResponseHeaders({
          launchSource,
          lastIndexedAt: identityGeneratedAt,
