...
const cliInstallCommands = [
  ...
  [
    'curl --fail --location --output "$programmable_cli_dir/programmable-launch-3.3.3.tgz" https://github.com/0xprogrammable/PROGRAMMABLE/releases/download/programmable-launch-v3.3.3/programmable-launch-3.3.3.tgz',
    "Download the pinned release asset.",
  ],
  [
    'curl --fail --location --output "$programmable_cli_dir/programmable-launch-3.3.3.tgz.sha256" https://github.com/0xprogrammable/PROGRAMMABLE/releases/download/programmable-launch-v3.3.3/programmable-launch-3.3.3.tgz.sha256',
    ...
    >
      ...
      <section id="quickstart">
        ...
        <ol className={styles.steps}>
          ...
          <li>
            Install <code>@programmable/launch</code> 3.3.3 from the{" "}
            <a href="https://github.com/0xprogrammable/PROGRAMMABLE/releases/download/programmable-launch-v3.3.3/programmable-launch-3.3.3.tgz">
      ...
      <section id="v3-general">
        ...
        <ul className={styles.checkList}>
          ...
          <li>
            ...
            challenge and authorization patch. CLI 3.3.3 uses{" "}
